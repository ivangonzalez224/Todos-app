...
**Todos** is a web app using React to build the project.
...
In this project we use React to build a to do list web app.
<details>
...
In this project it is used React to build a to do list web app.
